...
public class FollowerConstants {
    ...
    private static double xMovement = 58.9646;
    private static double yMovement = 42.1086;
    ...
    public static double mass = 11.068;
    ...
    public static double forwardZeroPowerAcceleration = -69.1836;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -112.3626;
    ...
    public static double pathEndVelocityConstraint = 0;
    ...
    // This can be custom set for each Path.
    public static double pathEndHeadingConstraint = Math.toRadians(2);
