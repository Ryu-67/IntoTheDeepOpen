...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 4.233953682040459; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 11.35;
        ...
        public double timeout = 0.6;
        public double positionalError = 1.5;
        public double headingError = 2.0;
    }
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if (((t >= timeTrajectory.duration) &&
                    (error.position.norm() < PARAMS.positionalError))// &&
//                    (Math.abs(Math.toDegrees(error.heading.toDouble())) < PARAMS.headingError))
