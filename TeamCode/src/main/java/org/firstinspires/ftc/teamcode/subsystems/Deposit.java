...
public class Deposit {
    ...
    public static double vert = 0.51, hori = 0.058, wrapped = 0.98, diag = 0.48/2;

    private boolean ispressed = false, spec = false;

    public static double aPitchUp=0.465, aPitchDown = 0.84, aPitchBack = 0.07
            , aPitchSpec = 0.44, specSlamPitch = 0.6, slamOnPitch = 0.45;

    public static double armDown = 0.23, armUp = 0.27, armBack = 0.235, armSpec = 0.48, specSlam = 0.4, slamPos = 0.15;
