...
public class MPPivot {
    ...
    TrapezoidProfile.Constraints upConstraints = new TrapezoidProfile.Constraints(3*Math.PI, 5*Math.PI), downConstraints = new TrapezoidProfile.Constraints(5*Math.PI, 2*Math.PI);
