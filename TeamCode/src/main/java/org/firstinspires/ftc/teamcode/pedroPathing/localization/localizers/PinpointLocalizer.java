...
public class PinpointLocalizer extends Localizer {
    ...
    public static GoBildaPinpointDriver.EncoderDirection xDirection = GoBildaPinpointDriver.EncoderDirection.FORWARD;
    ...
    public PinpointLocalizer(HardwareMap map, Pose setStartPose){
        ...
        setOffsets(3.877953, -5.5314961, DistanceUnit.INCH); //these are tuned for 3110-0002-0001 Product Insight #1
